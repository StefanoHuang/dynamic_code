...
class TransformerEncoderFinalLayer(Module):
    ...
    def __init__(self, d_model: int, nhead: int, dim_feedforward: int = 2048, dropout: float = 0.1,
        ...
        super(TransformerEncoderFinalLayer, self).__init__()
    ...
    def __setstate__(self, state):
        super(TransformerEncoderFinalLayer, self).__setstate__(state)
    ...
    def forward(self, src: Tensor, src_mask: Optional[Tensor] = None,
        ...
        x = src
        sa, atten_w = self._sa_block(self.norm1(x), src_mask, src_key_padding_mask)
        x = x + sa
